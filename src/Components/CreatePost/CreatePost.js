        ...
        <CardActions style={{ justifyContent: "space-between" }}>
          <div>
            <IconButton>
              ...
              <Typography variant="button" className={classes.ButtonText} >People</Typography>
            </IconButton>

            <IconButton>
              <RoomIcon style={{ color: "#ff1744" }} />
              <Typography className={classes.ButtonText} variant="button" >Check In</Typography>
            </IconButton>

            <IconButton>
              <EmojiEmotionsIcon style={{ color: "#ff9800" }}  />
              <Typography className={classes.ButtonText} variant="button">Mood</Typography>
            </IconButton>
          </div>
